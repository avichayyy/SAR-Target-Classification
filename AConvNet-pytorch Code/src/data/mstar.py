...
target_name_30d = ('2S1', 'BRDM2', 'ZSU234')
...
class MSTAR(object):
    ...
    def __init__(self, name='soc', is_train=False, use_phase=False, chip_size=94, patch_size=88, stride=1):
        self.name = name
    ...
    def _data_augmentation(self, data, patch_size=88, stride=1):
        # patch extraction
